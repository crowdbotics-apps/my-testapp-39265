"""
Django settings for my_testapp_39265 project.
...
ROOT_URLCONF = 'my_testapp_39265.urls'
...
WSGI_APPLICATION = 'my_testapp_39265.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_testapp_39265 API",
    "DESCRIPTION": "API documentation for my_testapp_39265 App",
    "VERSION": "v1",
}
